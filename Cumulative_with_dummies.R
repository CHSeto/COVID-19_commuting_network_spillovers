...
# response
#SWITCH BETWEEN CASES AND DEATHS TO CHANGE OUTCOME
data$cases <- (data$cases/data$total_pop)*1000
...
subset_predictors <- c("p65_over","ppopurban","disadvantage","abavg_nhw","abavg_nhb","abavg_hisp","n_covid","w_covid")
...
# write the output
write.csv(super_result, file = 'cases_super.csv',
          row.names = c("p65_over","ppopurban","disadvantage","abavg_nhw","abavg_nhb","abavg_hisp","n_covid","w_covid"))
write.csv(cbps_result, file = 'cases_cbps.csv',
          row.names = c("p65_over","ppopurban","disadvantage","abavg_nhw","abavg_nhb","abavg_hisp","n_covid","w_covid"))
write.csv(iptw_result, file = 'cases_iptw.csv',
          row.names = c("p65_over","ppopurban","disadvantage","abavg_nhw","abavg_nhb","abavg_hisp","n_covid","w_covid"))
